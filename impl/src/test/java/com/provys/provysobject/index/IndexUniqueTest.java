...
class IndexUniqueTest {
    ...
    void getTest() {
        ...
        var value = new TestNmObjectValue(BigInteger.valueOf(5), "NAME_NM", "Test");
        var nameNm = "NAME_NM";
        var value2 = new TestNmObjectValue(BigInteger.valueOf(5), "NAME2_NM", "Test2");
        ...
        // initial - empty
        assertThat(index.get(nameNm)).isEmpty();
        assertThat(index.get(nameNm2)).isEmpty();
        // change to value
        index.update(proxy, null, value);
        assertThat(index.get(nameNm)).containsSame(proxy);
        assertThat(index.get(nameNm2)).isEmpty();
        // change back to null
        ...
        assertThat(index.get(nameNm)).isEmpty();
        assertThat(index.get(nameNm2)).containsSame(proxy);
        // delete
